...
ResourceIndex has been designed to work with ActiveResource object, but can
...
If you specify the location, that location should exist or you may get errors.
